...
function Hero() {
  return (
    <section className="h-[50vh] xl:h-[80vh] overflow-hidden bg-[url('/local/hero-8.jpg')] relative bg-cover bg-center bg-no-repeat">
      ...
      <div className="relative z-10 text-white flex justify-center items-center h-full flex-col">
        ...
        <p className="text-lg xl:text-xl my-4 text-center">
          The perfect bus tour service for all your tours and airport transfers.
        </p>
